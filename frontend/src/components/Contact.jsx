      ...
      >
        {EnsembleContacts.filter((d) =>
          ...
          >
            ...
            >
              <Avatar
                sx={{ backgroundColor: "#FCA311", width: 300, height: 300 }}
                alt={frm.firstName}
                src={require("../img/sofiane.jpg")}
              />
              <Container
                sx={{
                  marginY: "30px",
              ...
              >
                ...
                >
                  ...
                  >
                    <a target="_blank" href={frm.gitLink}>
                      {frm.gitLink}
                    </a>
                  </Typography>
                </Container>
                ...
                >
                  ...
                  >
                    <a target="_blank" href={frm.linkedLink}>
                      {frm.linkedLink}
                    </a>
                  </Typography>
                </Container>
